      ...
      <div className='report-header'>
        <div className='report-header-wrapper'>
          <div className='report-header-title'>
            <Avatar sx={{ bgcolor: green[400] }} sizes='medium' className='grid-rowspan-2'>SJ</Avatar>
            <p className='grid-col-2'>Samuel Johnson</p>
            <span className='location-info grid-col-2 grid-row-2'>
            <Typography className='' sx={{ color: 'grey', fontSize: 14}}>Lagos, Nigeria </Typography>
            <PlaceIcon className='grid-col-2' sx={{ color: 'grey', fontSize: 14, cursor: 'pointer', marginLeft: .3}}/>
            </span>
          </div>
        ...
        <Button onClick={setOpen} sx={{height: 'min-content', marginLeft: 'auto'}}variant='contained'>
